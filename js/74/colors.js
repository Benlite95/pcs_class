(function () {
  ...
  function addColorsToTable(color, bgColor) {
    ...
    row.innerHTML = `
      <td>${new Date().toLocaleTimeString()}</td><td>${color}</td><td>${bgColor}</td>
    `;
    //row.style.color = color;
    //row.style.backgroundColor = bgColor;
    setColors(row, color, bgColor);

    const theRowClickCallback = rowClickHandler.bind(this, color, bgColor);
    row.addEventListener('click', /*() => {
      //document.body.style.color = color;
      //document.body.style.backgroundColor = bgColor;
      setColors(document.body, color, bgColor);
      stopColors();
    }*//*() => rowClickHandler(color, bgColor)*/theRowClickCallback);
  }

  function rowClickHandler(color, bgColor) {
    // console.log(x);
    //document.body.style.color = color;
    //document.body.style.backgroundColor = bgColor;
    setColors(document.body, color, bgColor);
