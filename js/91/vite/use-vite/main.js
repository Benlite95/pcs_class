import './style.css';
import snakeHeadSrc from './images/snakeHead.png';
import appleSrc from './images/apple.png';
import MessageBox from 'messagebox.js';
import './node_modules/messagebox.js/dist/themes/messagebox-default.min.css';
  ...
  move() {
    ...
    if (!gameOver) {
      ...
      if (recycledTail.x === apple.x && recycledTail.y === apple.y) {
        ...
        this.segments.push(recycledTail);
      }*/
...
let crashSound = new Audio(crashSrc);
let crunchSound = new Audio(crunchSrc);
...
console.log(potus.first, potus.last, potus);
